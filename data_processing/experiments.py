...
experiments = [
    {'id': '1', 'source':'yeast', 'target':'twitter', 'predicate':'proteinclass', 'to_predicate':'accounttype', 'arity': 2},
    #{'id': '2', 'source': 'yeast', 'target': 'cora', 'predicate': 'proteinclass', 'to_predicate': 'samevenue', 'arity': 2},
    #{'id': '2', 'source': 'yeast', 'target': 'nell_sports', 'predicate': 'proteinclass', 'to_predicate': 'teamplayssport', 'arity': 2},
    #{'id': '2', 'source': 'yeast', 'target': 'nell_finances', 'predicate': 'proteinclass', 'to_predicate': 'companyeconomicsector', 'arity': 2},
    
    #{'id': '2', 'source':'twitter', 'target':'yeast', 'predicate':'accounttype', 'to_predicate':'proteinclass', 'arity': 2},
    #{'id': '10', 'source':'twitter', 'target':'nell_finances', 'predicate':'accounttype', 'to_predicate':'companyeconomicsector', 'arity': 2},
...
sizes = {'imdb': [77, 78, 75, 57, 59],
         'uwcse': [311, 205, 287, 184],
         'yeast': [810, 754, 806, 771],
         'twitter': [178, 208],
         'nell_sports': [4548, 4548, 4548],
         'nell_finances': [3352, 3352, 3352],
         'cora': [679, 605, 614, 602, 600]}
...
# movie, title,protein,sportsteam -> 0.8
# person, author,account,athlete -> 0.1
# genre,level,venue,location,enzyme,sector -> 0.5
# course,project,class,phenotype,sportsleague, company -> 0.3
# quarter,prequeals,word, function,sport,city -> 0
# faculty,year,type,complex,country -> 0.6

colors = {
      'imdb': {'workedunder': [0.1,0.1],
              'female': [0.1],
              'actor': [0.1],
              'director': [0.1],
              'movie':[0.8,0.1],
      ...
      'uwcse': {'professor': [0.1],
        'student': [0.1],
        'advisedby': [0.1,0.1],
        'tempadvisedby': [0.1,0.1],
        'ta': [0.3,0.1,0],
        'hasposition': [0.1,0.6],
        'publication': [0.8,0.1],
        'inphase': [0.1,0],
        'courselevel': [0.3,0.5],
        'yearsinprogram': [0.1,0.6],
        'projectmember': [0.3,0.1],
        'sameproject': [0.3,0.3],
        'samecourse': [0.3,0.3],
        'sameperson': [0.1,0.1]},
      'cora': {'sameauthor': [0.1,0.1],
              'samebib': [0.3,0.3],
              'sametitle': [0.8,0.8],
              'samevenue': [0.5,0.5],
              'author': [0.3,0.1],
              ...
              'haswordtitle': [0.8,0],
              'haswordvenue': [0.5,0]},
      'twitter': {'accounttype': [0.1,0.6],
                  'tweets': [0.1,0],
                  'follows': [0.1,0.1]},
      'yeast': {'location': [0.8,0.5],
                'interaction': [0.8,0.8],
                'proteinclass': [0.8,0.3],
                'enzyme': [0.8,0.5],
                'function': [0.8,0],
                'complex': [0.8,0.6],
                'phenotype': [0.8,0.3]},
      'nell_sports': {'athleteledsportsteam': [0.1,0.8],
              'athleteplaysforteam': [0.1,0.8],
              'athleteplaysinleague': [0.1,0.3],
              'athleteplayssport': [0.1,0],
              'teamalsoknownas': [0.8,0.8],
              'teamplaysagainstteam': [0.8,0.8],
              'teamplaysinleague': [0.8,0.3],
              'teamplayssport': [0.8,0]},
      'nell_finances': {'countryhascompanyoffice': [0.6,0.3],
                        'companyeconomicsector': [0.3,0.5],
                        'economicsectorcompany': [0.5,0.3],
                        'companyceo': [0.3,0.1],
                        'companyalsoknownas': [0.3,0.3],
                        'cityhascompanyoffice': [0,0.3],
                        'acquired': [0.3,0.3],
                        'bankbankincountry': [0.1,0.6],
                        'bankboughtbank': [0.3,0.3],
                        'bankchiefexecutiveceo': [0.3,0.1]},
                      }